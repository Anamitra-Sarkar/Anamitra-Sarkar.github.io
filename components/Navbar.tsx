...
export const Navbar: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-stone-900 border border-zinc-200 dark:border-stone-800 shadow-xl shadow-zinc-200/10 dark:shadow-stone-900/20 px-8 py-4 rounded-2xl flex items-center gap-12 pointer-events-auto transition-colors duration-300">
